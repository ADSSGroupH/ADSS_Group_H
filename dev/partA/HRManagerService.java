...
public class HRManagerService {
    ...
    public void addEmployee(String id, String name, String phoneNumber,
                            Branch branch, Set<Role> roles, String bankDetails) {
        Employee newEmployee = new Employee(
                id, name, phoneNumber, branch,
                roles, null, bankDetails, false, null
        );
    ...
    public void createContract(String employeeId, String startDate, int freeDays, int sicknessDays,
        ...
        // יצירת חוזה חדש
        EmployeeContract newContract = new EmployeeContract(emp, startDate, freeDays, sicknessDays,
